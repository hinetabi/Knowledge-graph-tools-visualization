...
import { Diagram, DiagramEvents, DiagramType, FontStyle, IAutoPlacement, IBaseCoords, IMagneticConfig, IShapeToolbarConfig, TLineType, TextAlign, TextVerticalAlign, ILineRenderConfig, IDefaultShapeConfig } from "../../ts-diagram";
...
export interface ICopiedStylesConfig {
    type?: string;
    fill?: string;
    fontColor?: string;
    fontStyle?: FontStyle;
