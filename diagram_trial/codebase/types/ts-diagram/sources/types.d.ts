...
export declare type TLineType = "line" | "dash" | "none";
export declare type Arrows = "filled";
export declare type ArrowType = "forwardArrow" | "backArrow";
...
export interface IDiagramEventHandlersMap {
    ...
    [DiagramEvents.zoomIn]: (step: number) => void;
    [DiagramEvents.zoomOut]: (step: number) => void;
    /** @deprecated See a documentation: https://docs.dhtmlx.com/ */
